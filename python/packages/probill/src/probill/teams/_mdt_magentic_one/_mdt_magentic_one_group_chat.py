...
from ._mdt_orchestrator import MDTAgentOrchestrator
...
class MagenticOneGroupChat(BaseGroupChat, Component[MagenticOneGroupChatConfig]):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            participants,
            group_chat_manager_name="MDTAgentOrchestrator",
            group_chat_manager_class=MDTAgentOrchestrator,
    ...
    def _create_group_chat_manager_factory(
        ...
        max_turns: int | None,
    ) -> Callable[[], MDTAgentOrchestrator]:
        return lambda: MDTAgentOrchestrator(
            name,
            group_topic_type,
            output_topic_type,
