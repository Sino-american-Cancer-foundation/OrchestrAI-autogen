...
@mcp.tool(name="portal-login", description="Log into an insurance portal and capture a screenshot of the member information.")
...
@mcp.tool(name="analyze-image", description="Analyze an insurance portal screenshot to determine eligibility for a specific service date.")
...
@mcp.tool(name="get-call-results", description="Retrieve results from a completed insurance verification call. Keep checking until the call response is not unknown.")
...
@mcp.tool(name="run-vm-task", description="Run a background task on the VM that takes some time to fill out information into a third-party EMR/EHR system.")
