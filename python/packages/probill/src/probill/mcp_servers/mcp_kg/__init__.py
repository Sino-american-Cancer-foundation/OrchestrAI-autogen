...
def main():
    ...
    parser.add_argument("--db-url", default="bolt://localhost:7687", help="Neo4j connection URL")
    ...
    try:
        loop.run_until_complete(server.main(args.db_url, args.username, args.password, args.database, shutdown_event))
