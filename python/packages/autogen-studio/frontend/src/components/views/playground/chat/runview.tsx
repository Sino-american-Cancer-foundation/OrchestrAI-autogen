...
const RunView: React.FC<RunViewProps> = ({
            ...
            case "active":
                return (
                    <div className="inline-block mr-1">
                        ...
                        />
                        <span className="inline-block mr-2 ml-1 ">
                            Processing
                        </span>
                        <LoadingDots size={8} />
                    </div>
    ...
    const lastResultMessage =
        run.team_result?.task_result.messages.slice(-1)[0];
                ...
                <div className="text-xs text-secondary">
                    ...
                    {!isFirstRun && (
                        <>
                            ...
                            Note: Each run does not share data with previous
                            runs in the same session yet.
                        </>
                    )}
                </div>
            </div>
                            ...
                            <div className="mt-2 pl-4 border-secondary rounded-b border-l-2 border-secondary/30">
                                <div className="flex pt-2">
                                    ...
                                    <div className="text-sm text-secondary">
                                        {calculateThreadTokens(visibleMessages)}{" "}
                                        tokens | {visibleMessages.length}{" "}
                                        messages
                                    </div>
                                </div>
