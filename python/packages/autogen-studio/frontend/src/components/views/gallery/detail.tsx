...
const defaultConfigs: Record<ComponentTypes, ComponentConfig> = {
    team: {
        selector_prompt: "Default selector prompt",
        participants: [],
    } as any,
...
export const GalleryDetail: React.FC<{
    ...
    const handleAdd = () => {
        ...
        console.log("LOOKHEREBEN: ", newComponent);
        console.log("LOOKHEREBEN: ", category);
            ...
            <div>
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-base font-medium">
                        {
                            gallery.config.components[`${key}s` as CategoryKey]
                                .length
                        }{" "}
                        {gallery.config.components[`${key}s` as CategoryKey]
                            .length === 1
